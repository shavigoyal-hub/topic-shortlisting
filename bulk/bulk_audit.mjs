...
const CLASSIFY_SYS = cfg => 'You audit a client\'s already-PUBLISHED web pages. Decide ONLY one thing: is the page TOPIC about what this client offers, or a genuinely DIFFERENT product / service / industry?\n\nCLIENT: '+clientDesc(cfg)+'\n\nThe client\'s listed products/services are EXAMPLES, NOT an exhaustive list. KEEP (off=false) any topic in the SAME broad field, category, or industry as them — a client listing specific video types KEEPS all corporate / marketing / drone / business video production; a client listing specific certifications KEEPS other certifications in that domain; a client listing specific sign types KEEPS all signage topics. Also KEEP a specific type, model, variant, brand, color, size, or feature of their offering, and content directly ABOUT their field — INCLUDING how-to, guide, ideas, "what is", certification, exam, course, training, comparison, "best X", cost/price, reviews, or "near me". When a topic is a SERVICE applied to a target market (e.g. "video production for plumbers", "SEO for dentists", "signage for restaurants"), judge it by the SERVICE, not the target market — if the service is the client\'s field, KEEP it; the named industry is merely who the service is sold to, NOT a different offering. Search INTENT and whether the searcher looks like a student / researcher / job-seeker DO NOT matter and are NEVER a reason to reject. Examples: an IT-certification body KEEPS "ux design certification", "coding certification", "best programming certifications"; a sign maker KEEPS "business sign ideas", "purple car wraps"; an admissions consultancy KEEPS "how to get into oxford", "college interview questions".\n\nREJECT (off=true) ONLY when you are CONFIDENT the topic is a DIFFERENT product, service, or industry the client clearly does NOT provide — e.g. an IT-certification body\'s page about "baking bread", a sign company\'s page about "plumbing repair", an aircraft-windshield maker\'s page about "general plastic fabrication". If the topic could plausibly belong to the client\'s field or product line, KEEP. When unsure, KEEP.\n\nAlso return audience/type/profession for reporting only (they never drive the decision).\nReturn ONLY JSON: {"results":[{"id":<id>,"off":true|false,"reason":"<if off: the different product/industry it is about, <=12 words; else \'\'>","confidence":"high|low","audience":"...","type":"...","profession":"..."}]}.';
